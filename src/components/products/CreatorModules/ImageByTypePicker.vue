      ...
      >
        ...
        <div class="flex flex-col">
          ...
          <div class="mt-4 w-full cursor-pointer relative">
            <div
              v-if="!item.imageUrl"
              class="w-full h-[120px] border-[1px] rounded-md flex justify-center items-center"
            >
              <i class="ri-image-add-fill text-xl"></i>
              <AFilePicker v-model="item.imageUrl" class="absolute top-0 left-0 z-10" auto-upload="true" />
            </div>
